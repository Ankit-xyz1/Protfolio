  ...
  return (
    ...
    <motion.div>
      ...
      <div className='w-full h-fit flex flex-col justify-start text-white'>
        <div className='w-fit flex gap-0 items-center  text-sm'><AtSignIcon size={15}/> 0xanki7@gmail.com</div>
        <div className='w-fit flex gap-0 items-center text-sm'><SquarePenIcon size={15}/>My Blog <span className='text-xs ml-2 text-zinc-500'>not yet posted</span></div>
      </div>
    </motion.div>
  )
}
